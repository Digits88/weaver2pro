...
class Weaverii_Widget_Text extends WP_Widget {
		...
		function Weaverii_Widget_Text() {
				...
				parent::__construct('weaverii_text', weaverii_t_('Weaver II Text 2' /*a*/ ), $widget_ops, $control_ops);
		}
...
class Weaverii_Widget_PPText extends WP_Widget {
	...
	function Weaverii_Widget_PPText() {
		...
		parent::__construct('weaverii_pptext', weaverii_t_('Weaver II Per Page Text' /*a*/ ), $widget_ops);
	}
...
class Weaverii_Widget_Login extends WP_Widget {
		...
		function Weaverii_Widget_Login() {
				...
				parent::__construct('weaverii_login', weaverii_t_('Weaver II Login' /*a*/ ), $widget_ops);
		}
